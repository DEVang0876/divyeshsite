      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <motion.button
              className="px-4 py-2 border-2 border-[#87CEEB] text-sky-500 rounded-md hover:bg-[#87CEEB] hover:text-[#121212] transition-colors duration-300 font-fira"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => {
          ...
          >
            <div className="flex flex-col items-center justify-center h-full space-y-8">
              {navLinks.map((link, index) => (
                ...
                >
                  <Link
                    ...
                    className="text-white hover:text-sky-500 transition-colors duration-300 text-lg tracking-wider uppercase font-fira"
                  >
                    {link.name}
                  </Link>
                </motion.div>
              ...
              <motion.button
                ...
                className="px-6 py-3 border-2 border-[#87CEEB] text-sky-500 rounded-md hover:bg-[#87CEEB] hover:text-[#121212] transition-colors duration-300 font-fira"
              >
                Hire me
              </motion.button>
            </div>
